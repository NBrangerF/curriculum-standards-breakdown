...
assert.equal(manifest.routeCount, 13)
assert.equal(manifest.viewportCount, 5)
assert.equal(manifest.expectedArtifactCount, 65)
assert.equal(manifest.artifactCount, 65)
assert.equal(manifest.artifacts.length, 65)
