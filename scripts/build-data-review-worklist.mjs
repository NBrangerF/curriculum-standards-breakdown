...
const DOMAIN_TOKENS = {
    ...
    chinese: { '识字与写字': 'LI', '阅读与鉴赏': 'READ', '表达与交流': 'COMM', '梳理与探究': 'INQ' },
    english: { '语言能力': 'LANG', '文化意识': 'CUL', '思维品质': 'THINK', '学习能力': 'LEARN' },
    it: { '信息意识': 'IC', '信息社会责任': 'SR', '数字化学习与创新': 'DL', '计算思维': 'CS' },
    labor: { '日常生活劳动': 'DL', '生产劳动': 'PL', '服务性劳动': 'SL', '公益劳动与志愿服务': 'VL' },
    math: { '数与代数': 'ALG', '图形与几何': 'GEO', '统计与概率': 'STA', '综合与实践': 'PRJ' },
    morality_law: { '道德教育': 'MOR', '法治教育': 'LAW', '国情教育': 'NAT', '生命安全与健康教育': 'SAFE', '中华优秀传统文化与革命传统教育': 'CUL', '入学教育': 'ENR' },
    pe: { '运动技能': 'SK', '健康教育': 'HE', '体育品德': 'MO', '体能': 'FIT' },
