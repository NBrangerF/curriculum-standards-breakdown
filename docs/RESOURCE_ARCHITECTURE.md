...
但 README 和 glossary 中描述为：

- `H1`：1-2 年级
- `H2`：3-6 年级
- `H3`：7-9 年级

当前数据文件中也存在 `grade_range`，实际页面应以数据和产品定义统一后的口径为准。

建议：先确认本项目面向“小学阶段拆解”还是“义务教育全阶段拆解”，然后统一 README、glossary、`GRADE_BANDS`、数据字段和页面展示。
