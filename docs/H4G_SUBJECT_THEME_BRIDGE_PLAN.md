...
2026-07-03 新增只读 issue matrix，用来把 public H4G readiness、distinctiveness audit、English/PE anchor group gate 和 progression action evidence recommendations 合成同一张执行路线图：
...
针对这 52 条 source-anchor exact rows，新增 group review packet，把逐条 exact-anchor rows 先压缩到单元级审查面，避免把同一个 unit title 或泛主题误判成 7/8/9 年级已经完成区分：

```bash
npm run textbooks:h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-source-anchor-exact-group-review-packet -- --strict --require-items
npm run textbooks:audit-h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-source-anchor-exact-group-review-packet -- --strict --require-items
```

输出：

```text
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_packet_anchor_domain_rejected_english_pe.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_packet_anchor_domain_rejected_english_pe.md
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_packet_anchor_domain_rejected_english_pe_audit.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_packet_anchor_domain_rejected_english_pe_audit.md
```

当前 group review packet 为 `valid=true`，audit 结果为 `valid=true`：52 条 source-anchor exact evidence rows 被压缩成 7 个 unit-level review groups，missing exact evidence items 为 0、unexpected group rows 为 0。route 分布为 `single_unit_generic_or_deny_term_exact_anchor_review=5`、`single_unit_many_standard_generic_anchor_review=1`、`unit_or_standard_fanout_exact_anchor_group_review=1`；最大单组 25 条 standards，7 个组全部涉及多个 standards。这说明 H4G7/H4G8/H4G9 的“看起来 standards 几乎一样”主要来自同一教材单元/泛主题对多条 standards 的 fan-out，而不是已经有足够证据证明每条 standard 的年级锚点。该层只用于先确认 unit-level 证据是否能承载这些 standards，不写 editable decisions、不批准 bridge、不进入 matcher/publication。

针对这 7 个 unit-level review groups，新增可编辑 group-level decisions template，把“问题定位”推进到“人工可判定下一步”的小入口，但仍不直接批准任何 standard：

```bash
npm run textbooks:h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-source-anchor-exact-group-review-decisions -- --strict --require-items
npm run textbooks:audit-h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-source-anchor-exact-group-review-decisions -- --strict --require-items
```

输出：

```text
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_decisions_template_anchor_domain_rejected_english_pe.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_decisions_template_anchor_domain_rejected_english_pe.md
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_decisions_template_anchor_domain_rejected_english_pe_audit.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_decisions_template_anchor_domain_rejected_english_pe_audit.md
```
...
针对同一 7 条 exact group recommendations，新增 action worklist 层，把 recommendation-only 判断落成 reviewer 可执行队列。这个层仍然不是正式决策，只是防止“建议已识别但下一步不可执行”的中间状态继续漂浮：

```bash
npm run textbooks:h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-source-anchor-exact-group-review-action-worklist -- --strict --require-items
npm run textbooks:audit-h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-source-anchor-exact-group-review-action-worklist -- --strict --require-items
```

输出：

```text
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_action_worklist_anchor_domain_rejected_english_pe.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_action_worklist_anchor_domain_rejected_english_pe.md
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_action_worklist_anchor_domain_rejected_english_pe_audit.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_review_action_worklist_anchor_domain_rejected_english_pe_audit.md
```
...
在 split review surface 后，新增可编辑 standard-level split review decisions template。该层把 45 条标准级复核行变成 reviewer 可填写的决策入口，但仍然把“accept”限制为 later action gate candidate，不是 matcher/publication approval：

```bash
npm run textbooks:h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-source-anchor-exact-group-split-review-decisions -- --strict --require-items
npm run textbooks:audit-h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-source-anchor-exact-group-split-review-decisions -- --strict --require-items
```

输出：

```text
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_split_review_decisions_template_anchor_domain_rejected_english_pe.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_split_review_decisions_template_anchor_domain_rejected_english_pe.md
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_split_review_decisions_template_anchor_domain_rejected_english_pe_audit.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_split_review_decisions_template_anchor_domain_rejected_english_pe_audit.md
```
...
在 action evidence packet 后，新增 recommendation-only 下一步证据路由。这个层专门处理“H4G7/H4G8/H4G9 standards 看起来仍然一样”的问题：即使 page excerpts 已经 ready，也不能直接确认年级拆分；必须先判断缺的是 sibling public context、当前年级证据太泛，还是缺 sibling-grade source evidence。

```bash
npm run textbooks:h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-source-anchor-exact-group-split-review-progression-contrast-action-evidence-recommendations -- --strict --require-items
npm run textbooks:audit-h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-source-anchor-exact-group-split-review-progression-contrast-action-evidence-recommendations -- --strict --require-items
```

输出：

```text
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_split_review_progression_contrast_action_evidence_recommendations_anchor_domain_rejected_english_pe.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_split_review_progression_contrast_action_evidence_recommendations_anchor_domain_rejected_english_pe.md
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_split_review_progression_contrast_action_evidence_recommendations_anchor_domain_rejected_english_pe_audit.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_source_anchor_exact_group_split_review_progression_contrast_action_evidence_recommendations_anchor_domain_rejected_english_pe_audit.md
```
...
```bash
npm run textbooks:h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-bounded-source-evidence-packet -- --strict --require-items
npm run textbooks:audit-h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-bounded-source-evidence-packet -- --strict --require-items
```

输出：

```text
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_bounded_source_evidence_packet_anchor_domain_rejected_english_pe.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_bounded_source_evidence_packet_anchor_domain_rejected_english_pe.md
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_bounded_source_evidence_packet_anchor_domain_rejected_english_pe_audit.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_bounded_source_evidence_packet_anchor_domain_rejected_english_pe_audit.md
```
...
当前 confirmation evidence packet 为 `valid=true`，audit 结果为 `valid=true` 且 `require_text=true`、`require_body_text=true`：expected/audited evidence items 为 15/15，missing/extra 均为 0；15 条全部为 `text_extracted`、`body_text_ready=true` 且 `ready_for_manual_review=true`，`toc_only_items=0`。page hint source 为 unit index override 4 条、unit index hint 2 条、PDF title search 2 条、TOC hint 后正文标题回退 7 条；这 7 条原本来自目录页 hint，现已回退到正文页文本。sibling grade context 为 H4G7+H4G8 4 条、H4G7+H4G8+H4G9 4 条、H4G7+H4G9 7 条。该层仍只是 evidence packet，不修改 editable decisions、不批准 bridge、不写 `public/data`、不启用 matcher、不进入 publication。

在正文页证据 gate 后，新增非发布型 confirmation decisions candidate，把这 15 条 bounded-source rows 写成可审计的 reviewed decision candidate，同时保留 52 条 source-anchor exact rows 为 pending：

```bash
npm run textbooks:h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-manual-review-confirmation-decisions-candidate -- --strict --require-items
npm run textbooks:audit-h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-manual-review-confirmation-decisions-candidate -- --strict --require-items
npm run textbooks:audit-h4g-theme-bridge-anchor-group-item-review-downstream-post-candidate-manual-review-decisions -- --decisions generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_manual_review_confirmation_decisions_candidate_anchor_domain_rejected_english_pe.json --out generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_manual_review_confirmation_decisions_candidate_anchor_domain_rejected_english_pe_generic_audit.json --summary-out generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_manual_review_confirmation_decisions_candidate_anchor_domain_rejected_english_pe_generic_audit.md --strict --require-items
```

输出：

```text
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_manual_review_confirmation_decisions_candidate_anchor_domain_rejected_english_pe.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_manual_review_confirmation_decisions_candidate_anchor_domain_rejected_english_pe.md
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_manual_review_confirmation_decisions_candidate_anchor_domain_rejected_english_pe_audit.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_manual_review_confirmation_decisions_candidate_anchor_domain_rejected_english_pe_audit.md
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_manual_review_confirmation_decisions_candidate_anchor_domain_rejected_english_pe_generic_audit.json
generated/textbook_evidence/h4g_theme_bridge_anchor_group_item_review_downstream_post_candidate_manual_review_confirmation_decisions_candidate_anchor_domain_rejected_english_pe_generic_audit.md
```
